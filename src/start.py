...
def run():
    ...
    network.train(loss_fn, optim.Adam(network.model.parameters(), lr=5e-4), num_epochs=1)
    network.train(loss_fn, optim.Adam(network.model.parameters(), lr=1e-4), num_epochs=2)
