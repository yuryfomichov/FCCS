...
def run():
    ...
    network.train(loss_fn, optim.Adam(network.model.parameters(), lr=3e-5), num_epochs=1)
    network.train(loss_fn, optim.Adam(network.model.parameters(), lr=1e-5), num_epochs=1)
    network.train(loss_fn, optim.Adam(network.model.parameters(), lr=3e-6), num_epochs=1)
